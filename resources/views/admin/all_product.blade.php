              ...
              <td>
                <span class="text-ellipsis">
                    <?php
                      ...
                      ?>
                        <a href="{{URL::to('/unactive-product/'.$pro->product_id)}}"><span class="fa-off fa fa-power-off"></span></a>  
                    <?php
                        }else{
                      ?>
                          <a href="{{URL::to('/active-product/'.$pro->product_id)}}"><span class="fa-on fa fa-power-off"></span></a> 
                    <?php
                        }
                      ?>
                </span>
